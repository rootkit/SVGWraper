...
void DataProc::normalizeFaceData(vector<Point> &testPoints, vector<Point> &targetPoints) {
    ...
    // 边界中间插值点
    targetPoints.push_back(Point(targetPoints[78].x, (targetPoints[78].y+targetPoints[79].y)/2));
    targetPoints.push_back(Point((targetPoints[79].x+targetPoints[80].x)/2, targetPoints[79].y));
    targetPoints.push_back(Point(targetPoints[80].x, (targetPoints[80].y+targetPoints[81].y)/2));
    targetPoints.push_back(Point((targetPoints[78].x+targetPoints[81].x)/2, targetPoints[81].y));
    ...
    // 边界中间插值点
    testPoints.push_back(Point(testPoints[78].x, (testPoints[78].y+testPoints[79].y)/2));
    testPoints.push_back(Point((testPoints[79].x+testPoints[80].x)/2, testPoints[79].y));
    testPoints.push_back(Point(testPoints[80].x, (testPoints[80].y+testPoints[81].y)/2));
    testPoints.push_back(Point((testPoints[78].x+testPoints[81].x)/2, testPoints[81].y));
